...
namespace Animal_Hotel.source
{
    public partial class Outdoor : System.Web.UI.Page
    {
        ...
        private void LoadBreeds(string petType)
        {
            ...
            {
                string query = "SELECT DISTINCT PetBreed FROM PetProfiles WHERE PetType = @PetType AND IndoorOutdoor = 'Outdoor'";
                ...
                try
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        typeList.InnerHtml += $"<option value='{breed}'>";
                    }
                }
                catch (Exception ex)
                {
        ...
        private void LoadExistingPets()
        {
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                string query = "SELECT PetID, PetName, PetType, PetBreed FROM PetProfiles " +
                             "WHERE OwnerUsername = @username AND IndoorOutdoor = 'Outdoor'";
                SqlCommand cmd = new SqlCommand(query, con);
            ...
            if (rblReservationType.SelectedValue == "manual")
            {
                ...
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    ...
                    try
                    {
                        ...
                        cmd.Parameters.AddWithValue("@PetBreed", txtType.Text);
        ...
        private void CreateReservation(int petId, SqlConnection con = null, SqlTransaction transaction = null)
        {
            ...
            if (con == null)
            {
                ...
                localTransaction = con.BeginTransaction();
            }
            ...
            try
            {
                ...
                string insertReservationQuery = @"INSERT INTO Reservations 
                    ...
                    VALUES 
                    (@PetID, @username, 'Outdoor', @AdditionalInfo, GETDATE(), @CheckInDate, @CheckOutDate)";

                SqlCommand cmd = new SqlCommand(insertReservationQuery, con, transaction);
                ...
                <div class='nav-item'>
                    ...
                    <div class='dropdown'>
                        ...
                        <div class='sub-dropdown'>
                            ...
                            <a class='dropdown-item'>Outdoor</a>
                        </div>
