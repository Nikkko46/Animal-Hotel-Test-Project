<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Outdoor.aspx.cs" Inherits="Animal_Hotel.source.Outdoor" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="content">
            <div class="welcome-section">
                <h1>Outdoor Pet Accommodation</h1>
                <p class="tagline">Attention, Comfort, and Care for Your Outdoor Companions</p>
            </div>
            ...
            <div class="features-container">
                <div class="feature-section">
                    ...
                    <div class="feature-content">
                        <h2>Funky Outdoor Pet Suites</h2>
                ...
                <div class="amenities-grid">
                    ...
                    <div class="amenity-item">
                        ...
                        <p>Regular grooming and maintenance for every type of pet!😸</p>
                    </div>
                </div>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="pnlManualEntry" runat="server" Visible="false" CssClass="reservation-form">
                            ...
                            <div class="form-group" id="typeSection" runat="server">
                                <label for="txtType">Type:</label>
                                <asp:TextBox ID="txtType" runat="server" CssClass="form-control" list="typeList"></asp:TextBox>
                                <datalist id="typeList" runat="server">
                                </datalist>
                            </div>
